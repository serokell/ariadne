...
import Ariadne.UI.Model (AppState, initialAppState)
import Ariadne.UI.Controller (app)
...
createAriadneUI :: IO (UiFace, AuxxFace -> IO ())
createAriadneUI = do
...
-- completes.
runUI :: BChan AuxxEvent -> AuxxFace -> IO ()
