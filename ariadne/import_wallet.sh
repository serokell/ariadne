...
ARIADNE_WALLET_PATH=ariadne/src/Ariadne/Wallet/Cardano
...
find ariadne/src/Ariadne/Wallet/Cardano/ -name '*.hs' -exec sed -e 's/\bCardano\.Wallet\./Ariadne.Wallet.Cardano./g' -i {} \;
