...
import Test.QuickCheck
  (Gen, Property, arbitrary, choose, conjoin, counterexample, forAll)
...
import Ariadne.Wallet.Cardano.Kernel.CoinSelection
  (CoinSelFinalResult(..), CoinSelHardErr(..), CoinSelPolicy,
...
import Ariadne.Wallet.Cardano.Kernel.CoinSelection.FromGeneric
  (estimateCardanoFee, estimateHardMaxTxInputs, estimateMaxTxInputs)
...
import Test.Spec.CoinSelection.Generators
  (InitialBalance(..), Pay(..), genFiddlyPayees, genFiddlyUtxo, genGroupedUtxo,
