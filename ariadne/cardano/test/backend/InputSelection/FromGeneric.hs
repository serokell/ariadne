...
import qualified Ariadne.Wallet.Cardano.Kernel.CoinSelection.Generic.LargestFirst as Generic
import Ariadne.Wallet.Cardano.Kernel.CoinSelection.Generic.Random
  (PrivacyMode(..))
import qualified Ariadne.Wallet.Cardano.Kernel.CoinSelection.Generic.Random as Generic
