...
data WalletFace =
  WalletFace
    ...
    , walletRenameAccount :: AccountReference -> Text -> IO ()
    , walletRenameWallet :: WalletReference -> Text -> IO ()
    , walletRemoveAccount :: AccountReference -> Bool -> IO ()
    , walletRemoveWallet :: WalletReference -> Bool -> IO ()
    , walletRefreshState :: IO ()
    , walletSend ::
        Bool -> WalletReference -> [LocalAccountReference] ->
        InputSelectionPolicy -> NonEmpty TxOut -> IO TxId
    , walletAccountBalance :: AccountReference -> IO Coin
    , walletWalletBalance :: WalletReference -> IO Coin
    }
