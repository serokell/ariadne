...
module Ariadne.Wallet.Cardano.Kernel.Submission (
    -- * Public API
      newWalletSubmission
    , addPending
    , remPending
...
import Ariadne.Wallet.Cardano.Kernel.DB.HdWallet (HdAccountId)
import Ariadne.Wallet.Cardano.Kernel.DB.InDb (fromDb)
import Ariadne.Wallet.Cardano.Kernel.DB.Spec
  (Pending(..), emptyPending, pendingTransactions, removePending, unionPending)
